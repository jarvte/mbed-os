...
#ifndef GEMALTO_EMS31_CELLULAR_NETWORK_H_
#define GEMALTO_EMS31_CELLULAR_NETWORK_H_

#include "GEMALTO_CINTERION_CellularNetwork.h"

namespace mbed {

class GEMALTO_EMS31_CellularNetwork : public GEMALTO_CINTERION_CellularNetwork
{
public:
    GEMALTO_EMS31_CellularNetwork(ATHandler &atHandler);
    virtual ~GEMALTO_EMS31_CellularNetwork();
...
#endif // GEMALTO_EMS31_CELLULAR_NETWORK_H_
