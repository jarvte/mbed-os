...
#ifndef GEMALTO_BGS2_CELLULAR_NETWORK_H_
#define GEMALTO_BGS2_CELLULAR_NETWORK_H_

#include "GEMALTO_CINTERION_CellularNetwork.h"

namespace mbed {

class GEMALTO_BGS2_CellularNetwork : public GEMALTO_CINTERION_CellularNetwork
{
public:
    GEMALTO_BGS2_CellularNetwork(ATHandler &atHandler);
    virtual ~GEMALTO_BGS2_CellularNetwork();
...
#endif // GEMALTO_BGS2_CELLULAR_NETWORK_H_
